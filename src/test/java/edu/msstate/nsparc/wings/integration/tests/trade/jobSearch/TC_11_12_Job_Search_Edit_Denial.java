...
@TestCase(id = "WINGS-10743")
public class TC_11_12_Job_Search_Edit_Denial extends BaseWingsTest {
    ...
    public void main() {
        ...
        logStep("Press 'Edit Denial' button for the Denial");
        denialSectionForm.editDenial();

        logStep("Check that Edit Denial page is opened");
        new EditDenialForm();
    }
}
