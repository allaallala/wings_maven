...
@TestCase(id = "WINGS-11190")
public class TC_32_14_03_APP_Each_Status extends BaseWingsTest {
    private String[] arrayJobs = new String[3];
    private String[] arrayResults = {"Not Qualified", "Filled by Employer", "Refused Referral"};
    ...
    public void main() {
        ...
        for (int i = 0; i < 3; i++) {
            softTrue("Record #" + (i + 1) + " has incorrect status",
                    viewYourApplicationsForm.getStatusOfApplication(i).equals(arrayResults[i])
                            && viewYourApplicationsForm.getRecord(i).contains(arrayJobs[i]));
        }
    }
