...
@TestCase(id = "WINGS-10651")
public class TC_06_05_ATAA_RTAA_Enrollment_85000_Full_Workflow extends BaseWingsTest {


    public void main() {


        AtaaRtaaEnrollment ataaRtaaEnrollment = new AtaaRtaaEnrollment(PetitionType.TAA_2014);
