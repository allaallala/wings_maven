...
@TestCase(id = "WINGS-10498")
public class TC_01_02_Participant_Create_Regular extends BaseWingsTest {

    public void main() {
        logStep("Login to the System with Unemployment Services System Username and Password");
        BaseNavigationSteps.loginParticipant();

        logStep("During registration, select No from radio button 'Is the participant a veteran', fill all required fields");
